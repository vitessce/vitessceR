...
We currently use [reticulate](https://rstudio.github.io/reticulate/) to write to Zarr stores via the ``zarr`` Python package.

We recommend using [conda](https://docs.conda.io/en/latest/) with the following ``environment.yml`` file:

* https://github.com/vitessce/vitessce-r/blob/main/environment.yml
