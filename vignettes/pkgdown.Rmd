...
The Vitessce widget can be embedded in a static website built with pkgdown. In fact, this documentation website was built with pkgdown, and both of the remote data examples ([Usage with JSON: Remote Example](./json_remote.html) and [Usage with OME-TIFF: Remote Example](./ome_tiff_remote.html)) take advantage of the ability to render R htmlwidgets into a pkgdown website.
