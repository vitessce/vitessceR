...
The Vitessce widget can be embedded in a static website built with pkgdown. In fact, this documentation website was built with pkgdown, and both of the remote data examples ([Usage with JSON: Remote Example](articles/json_remote.html) and [Usage with OME-TIFF: Remote Example](articles/ome_tiff_remote.html)) take advantage of the ability to render R htmlwidgets into a pkgdown website.
...
* https://github.com/vitessce/vitessce-r/blob/main/vignettes/json_remote.Rmd
* https://github.com/vitessce/vitessce-r/blob/main/vignettes/ome_tiff_remote.Rmd
* Pkgdown configuration files: https://github.com/vitessce/vitessce-r/tree/main/pkgdown
* GitHub Actions deployment script: https://github.com/vitessce/vitessce-r/blob/main/.github/workflows/deploy.yml#L30
