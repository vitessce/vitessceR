...
The code used to create the Giotto object has been adapted from the [Giotto tutorial](http://spatialgiotto.rc.fas.harvard.edu/giotto.seqfish.html).
...
# Set up working directory and Python path according to the Giotto instructions
my_working_dir = file.path(path.expand("~"), "Downloads", "Giotto")
python_path = file.path(path.expand("~"), "anaconda3", "envs", "giotto-env", "bin", "python")

# Download example dataset
getSpatialDataset(dataset = 'seqfish_SS_cortex', directory = my_working_dir, method = 'wget')

# Create a Giotto object
# 1. Set Giotto instructions
